...
const Cart = () => {
  ...
  if (carts.length === 0) {
    return <div style={{ fontSize: '100px', fontStyle: 'bold', textAlign: 'center', height: '70vh', paddingTop: '180px' }}><h1>Cart is Empty</h1></div>
  }
  return (
    <section>
        ...
        <div className="flex flex-wrap shadow-md my-10">
                  ...
                  <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                    <div className="flex w-2/5">
                      ...
                      <div className="flex flex-col justify-between ml-4 flex-grow">
                        ...
                        <div className="font-semibold hover:text-red-500 text-gray-500 text-xs cursor-pointer uppercase" onClick={() => removeProduct(cart?.id)}>Remove</div>
                      </div>
                    </div>
          ...
          <div id="summary" className="w-1/4 px-8 py-10">
            ...
            <div className="border-t mt-8">
              ...
              <button className="bg-indigo-500 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full" onClick={()=>{alert("We can't accept online orders right now")}}>Checkout</button>
            </div>
          </div>
